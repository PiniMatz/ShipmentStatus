...
def fetch_gmail_shipments():
    ...
    try:
        ...
        # Search for Amazon, AliExpress, or Ordered keywords across subject/body starting May 1st, 2026
        query = '("Amazon" OR "AliExpress" OR "Ordered") ("order" OR "shipment" OR "tracking" OR "shipped" OR "delivered" OR "confirmation") after:2026/05/01'
